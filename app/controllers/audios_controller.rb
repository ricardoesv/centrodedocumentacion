class AudiosController < ApplicationController
  ...
  private
    ...
    def audio_params
      params.require(:audio).permit(:titulo, :subtitulo, :autor, :colaborador, :clasificacion, :editorial, :edicion, :edicion, :serie, :traduccion, :bibliografia, :indice, :apendice, :apendice, :isbn, :contenido, :cantidad, :acervo, :ano_publicacion, :anaquel, :peldano)
    end
end
